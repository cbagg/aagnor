...
//80
sh_int                  gen_final_verdict;
sh_int                  gen_heretic_bane;
...
DECLARE_EFF_UPDATE(     final_verdict_init	);
DECLARE_EFF_UPDATE(     final_verdict_kill	);
DECLARE_EFF_UPDATE(     final_verdict_postdamage);
DECLARE_EFF_UPDATE(     final_verdict_parry	);

DECLARE_EFF_UPDATE(     heretic_bane_init	);
DECLARE_EFF_UPDATE(     heretic_bane_kill	);
DECLARE_EFF_UPDATE(     heretic_bane_postdamage );
DECLARE_EFF_UPDATE(     heretic_bane_parry	);
