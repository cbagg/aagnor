...
DECLARE_SPELL_FUN(      spell_bone_spear        );
DECLARE_SPELL_FUN(      spell_bone_wall         );
...
DECLARE_SPELL_FUN(      spell_shadowmeld        );
DECLARE_SPELL_FUN(      spell_soul_tear         );
...
DECLARE_SPELL_FUN(      spell_harden_def        );
...
DECLARE_SPELL_FUN(      spell_magic_disc        );
...
DECLARE_SPELL_FUN(      spell_negative_blast    );
...
DECLARE_SPELL_FUN(      spell_wraith_swarm      );
...
DECLARE_SPELL_FUN(      spell_grasp_crypt       );
...
DECLARE_SPELL_FUN(      spell_dark_heart        );
...
DECLARE_SPELL_FUN(      spell_ward_of_binding   );
...
DECLARE_SPELL_FUN(      spell_cloak_shades      );
