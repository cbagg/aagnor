...
void fire_effect(void *vo, int level, int dam, int target)
{
  if (target == TARGET_CHAR){
	...
	if (victim->class == gcn_lich) {
	  act("The smoke drifts harmlessly through $n's hollow eye sockets.",victim,NULL,NULL,TO_ROOM);
	  act("The smoke drifts lazily through your hollow eye sockets.",victim,NULL,NULL,TO_CHAR);
	  return;
	}
