...
#define MAIN_PORT		1848
#define TEST_PORT		1849
...
#define LAG_SHIELD_BONE         4//wall of bone 
...
#define LAG_SHIELD_MALFORM      13//Knowledge Malform
...
#define MOB_VNUM_SKELETON	   59
#define MOB_VNUM_MANTICORE	   60
#define MOB_VNUM_NIGHTMARE	   61
#define MOB_VNUM_UMBERHULK   	   62
#define MOB_VNUM_BASILISK	   63
#define MOB_VNUM_HIPPOGRYPH	   64
#define MOB_VNUM_GORGON		   65
...
#define OBJ_VNUM_PHYLACTERY          93
#define OBJ_VNUM_MAGIC_DISC          94
...
#define OBJ_VNUM_VALMIRAN_MAP	   7798
#define OBJ_VNUM_RHEYDIN_MAP	   7798
#define OBJ_VNUM_S_SERINGALE_MAP   7798
#define OBJ_VNUM_E_THERA_MAP   	   7798
#define OBJ_VNUM_W_THERA_MAP       7798
#define OBJ_VNUM_WHISTLE	   7798

#define OBJ_VNUM_SCHOOL_CROSSBOW     7798 
...
extern sh_int  gsn_ward_of_binding;
...
extern sh_int  gsn_magic_strike;
extern sh_int  gsn_harden_def;


/* LICHES */
extern sh_int  gsn_phylactery;
extern sh_int  gsn_bone_spear;
extern sh_int  gsn_bone_wall;
extern sh_int  gsn_soul_tear;
...
extern sh_int gen_final_verdict;
...
void    check_bone_wall args(( CHAR_DATA *ch, CHAR_DATA *victim, int multi) );
int     check_phylactery args(( CHAR_DATA *ch) );
void    update_phylactery args(( CHAR_DATA *ch, int change) );
...
bool    check_wall              args( ( CHAR_DATA *ch, CHAR_DATA *victim, OBJ_DATA* vir_obj, int dt, int h_roll, int level, bool fVirt, int sn) );
