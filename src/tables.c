...
const struct jail_type jail_table[MAX_HOMETOWN] =
{
  ...
  {"",		32622,	32623,	{32624, 32628, 32625}, 32513,	32622},
  {NULL,	0,	0,	{0, 0, 0},	       0,	    0}
};
...
const struct deity_type deity_table[MAX_DIETY]=
{
  ...
  {
    "Compassion",	"Koevhar",	PATH_LIFE,
    DIETY_ALIGN_GOOD,
    DIETY_ETHOS_LAWFUL | DIETY_ETHOS_NEUTRAL | DIETY_ETHOS_CHAOTIC,
    9200, 180,
  },
  {
    "Purity",		"Irumeru",	PATH_LIFE,
    DIETY_ALIGN_GOOD,
    DIETY_ETHOS_LAWFUL | DIETY_ETHOS_NEUTRAL | DIETY_ETHOS_CHAOTIC,
    8900, 181,
  },
  {
    "Tranquility",	"Koevhar",	PATH_LIFE,
    DIETY_ALIGN_GOOD,
    DIETY_ETHOS_LAWFUL | DIETY_ETHOS_NEUTRAL | DIETY_ETHOS_CHAOTIC,
    3598, 182,
  },
  ...
  {
    "Scourge",		"Chayesh",	PATH_DEATH,
    DIETY_ALIGN_EVIL,
    DIETY_ETHOS_LAWFUL | DIETY_ETHOS_NEUTRAL | DIETY_ETHOS_CHAOTIC,
    2718, 191,
  },
  {
    "Cycle",		"Chayesh",	PATH_DEATH,
    DIETY_ALIGN_EVIL,
    DIETY_ETHOS_LAWFUL | DIETY_ETHOS_NEUTRAL | DIETY_ETHOS_CHAOTIC,
    3472, 30001,
  },
  {
    "Necropsy",		"Chayesh",	PATH_DEATH,
    DIETY_ALIGN_EVIL,
    DIETY_ETHOS_LAWFUL | DIETY_ETHOS_NEUTRAL | DIETY_ETHOS_CHAOTIC,
    2200, 192,
  },
  ...
  {
    "Discord",		"Malchaeius",	PATH_CHANCE,
  ...
  {
    "Order",		"Prax",	PATH_EQUIL,
    DIETY_ALIGN_NEUTRAL,
    DIETY_ETHOS_LAWFUL,
    8890, 183,
  },
  {
    "Neutrality",	"Isadora",	PATH_EQUIL,
    DIETY_ALIGN_NEUTRAL,
    DIETY_ETHOS_NEUTRAL,
    2719, 185,
  },
  {
    "Chaos",		"Malchaeius",	PATH_EQUIL,
    DIETY_ALIGN_NEUTRAL,
    DIETY_ETHOS_CHAOTIC,
    1499, 184,
  },
  ...
  {
    "Mystic",		"Anithraril",	PATH_KNOW,
    DIETY_ALIGN_GOOD | DIETY_ALIGN_NEUTRAL | DIETY_ALIGN_EVIL,
    DIETY_ETHOS_LAWFUL | DIETY_ETHOS_NEUTRAL | DIETY_ETHOS_CHAOTIC,
    1484, 186,
  },
  {
    "Combat",		"Thinoth",	PATH_KNOW,
    DIETY_ALIGN_GOOD | DIETY_ALIGN_NEUTRAL | DIETY_ALIGN_EVIL,
    DIETY_ETHOS_LAWFUL | DIETY_ETHOS_NEUTRAL | DIETY_ETHOS_CHAOTIC,
    990, 187,
  },
  {
    "Nature",		"Eshaine",	PATH_KNOW,
    DIETY_ALIGN_GOOD | DIETY_ALIGN_NEUTRAL | DIETY_ALIGN_EVIL,
    DIETY_ETHOS_LAWFUL | DIETY_ETHOS_NEUTRAL | DIETY_ETHOS_CHAOTIC,
    2530, 196,
  },
...
const   struct attack_type      attack_table    [MAX_DAMAGE_MESSAGE]    =
{
    ...
    { "telekinesis",    "telekinesis",  DAM_AIR 	}, /* 70 */
...
//55
	...
	{ "Initiate of Horrors",	"Initiate of Horrors"	        },
	{ "Initiate of Agony",  	"Initiate of Agony"		},
	{ "Initiate of Necropsy",	"Initiate of Necropsy"		},
	{ "Initiate of Damnation",      "Initiate of Damnation"         },

	{ "Initiate of Bones",		"Initiate of Bones"		},
	{ "Initiate of Blight",		"Initiate of Blight"		},
	{ "Initiate of Crypts",		"Initiate of Crypts"		},
	{ "Initiate of Corpses",	"Initiate of Corpses"		},
	{ "Initiate of Unlife",		"Initiate of Unlife"		},

	{ "Consumer of Marrow",		"Consumer of Marrow"		},
	{ "Open Grave",			"Open Grave"			},
	{ "Phantasm",		        "Phantasm"       		},
	{ "Stuff of Nightmares",	"Stuff of Nightmares"		},
	{ "Unliving Terror",		"Unliving Terror"		},

	{ "Dark Spectre",		"Dark Spectre"			},
	{ "Defiler",			"Defiler"			},
	{ "Boneweaver",			"Boneweaver"			},
	{ "Damner of Souls",		"Damner of Souls"		},
	{ "Lich",			"Lich"   			},

	{ "Dark Thaumaturgist",		"Dark Thaumaturgist"		},
	{ "Reaver of Pain",		"Reaver of Pain"		},
	{ "Bonemage",			"Bonemage"			},
	{ "Power Fiend",		"Power Fiend"   		},
	{ "Devourer of Souls",		"Devourer of Souls"		},

	{ "Flesh Harrower",	        "Flesh Harrower"		},
	{ "Master Lich",		"Mistress Lich"			},
	{ "Nether Mage",         	"Nether Mage"    		},
	{ "Lord of Decay",		"Lady of Decay"			},
	{ "Lich King",			"Lich Queen"			},

	{ "Undying",    		"Undying"       		},
	{ "Summoner of Shades",		"Summoner of Shades"		},
	{ "Eyeless Visage",		"Eyeless Visage"		},
	{ "Essense of Fear",    	"Essense of Fear"       	},
	{ "Archmage of Rot",		"Archmage of Rot"		},

	{ "Stygian Reaper",  "Stygian Reaper"},
	{ "Epitome of Malice",  "Epitome of Malice"},
	{ "Summoner of Wraiths",  "Summoner of Wraiths"},
	{ "Shatterer of Souls",  "Shatterer of Souls"},
	{ "Demilich",  "Demilich"},
	
	{ "Stygian Horror",  "Stygian Horror"},
	{ "Marrowlord",  "Marrowlady"},
	{ "Everlasting Quiet",  "Everlasting Quiet"},
	{ "Lord of the Dead",  "Lady of the Dead"},
	{ "Antithesis of Life",  "Antithesis of Life"},
	
	{ "Eternal Decay",  "Eternal Decay"},
	{ "Grasp of the Crypt",  "Grasp of the Crypt"},
	{ "Voice of the Continuum",  "Voice of the Continuum"},
	{ "Avatar of Unlife",  "Avatar of Unlife"},
	{ "Chosen of the Nameless",  "Handmaiden of the Nameless"},
	
	{ "Lich Hero",	        	"Lich Heroine"   		},
	{ "Avatar of Unlife",		"Avatar of Unlife"		},
	{ "Angel of Unlife",		"Angel of Unlife"		},
	{ "Demigod of Unlife",		"Demigoddess of Unlife"		},
	{ "Immortal Lich",		"Immortal Lich"  		},
	{ "God of Unlife",		"God of Unlife"			},
	{ "Deity of Unlife",		"Deity of Unlife"		},
	{ "Supreme Master of Unlife",	"Supreme Mistress of Unlife"	},
        { "Creator",                    "Creator"                       },
	{ "Implementor",		"Implementress"			}
    }
};
...
/* FINAL PARTING */
  {130, 1, 100,					//vnum, amount chance, 
   0,0, 10601,10601,				//amin, amax, rmin, rmax
   {"Faction of Blood"}, 1,					//areas by name to select from
   {"valmiran", "rheydin", "miruvhor", "order of crusades"},4,	//areas by name to exclude
   {0}, 0,					//sectors required
   {SECT_AIR, SECT_WATER_SWIM, SECT_WATER_NOSWIM, SECT_LAVA}, 4,	//sectors excluding choice
   {0}, 0,					//room1 flags required
