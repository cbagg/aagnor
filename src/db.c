...
sh_int                  gsn_bone_spear;
sh_int                  gsn_soul_tear;
...
sh_int                  gsn_phylactery;
sh_int                  gsn_magic_strike;
sh_int                  gsn_harden_def;
...
/* CLEAR STRING ALOCATION */
    ...
    log_string("Load function complete");
}
